...
import {ScheduleRequestDto} from "./request/calendar";
...
const SCHEDULE_URL = () =>`${API_DOMAIN}/calendar/schedule`
...
export const scheduleRequest = async (requestBody: ScheduleRequestDto, accessToken:string) => {
