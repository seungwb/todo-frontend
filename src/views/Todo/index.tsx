...
export default function Todo(){
    ...
    const addTodo = () => {
        setTodos([...todos, { ...newTodo, id: Date.now(), reg_date: new Date().toLocaleDateString(), completed: false }]);
        setTitle('');
        setContent('');
        setState(true);
    ...
    return (
        <div className="p-6 bg-gray-50 min-h-screen flex flex-col items-center">
            ...
            <TodoModal isOpen={isModalOpen} closeModal={() => setIsModalOpen(false)} addTodo={addTodo} title={setTitle} content = {setContent}/>
